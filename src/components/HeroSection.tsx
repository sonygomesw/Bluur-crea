          ...
          <div className="flex flex-col items-center text-center mb-20">            
            ...
            <div className={`mb-12 transform transition-all duration-1000 delay-200 ${
              ...
              <div className="inline-flex flex-col items-center gap-3 bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-gray-600 font-manrope">
                  <span className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    Trusted by 11,000+ artists
                  </span>
                ...
                <div className="text-xs text-gray-500 font-manrope text-center">
